...
<table border="0" width="100%" class="standard">
    ...
    <tr>
        ...
        <td class="submenueC subMenueLink" onClick="location.href='http://www.heise.de'" onmouseover="showInformation('Datei - Upload','Stammdaten','Centron')" onmouseout="clearInformation()">
            Centron
        </td>
    </tr>
    <tr>
